...
// TODO: Use source generation and add Interop.Resolver so that we don't need this.

/// <summary>
/// A SigScanner facilitates searching for memory signatures in a given ProcessModule.
/// </summary>
public interface ISigScanner {
    private static ISigScanner? instance;

    /// <summary>
    /// Gets or sets the global <see cref="ISigScanner"/> instance to use when scanning in KhStructs.
    /// </summary>
    public static ISigScanner? Instance {
        get {
            if (instance is null) {
                throw new Exception("[KhStructs.ISigScanner] Attempted to use KhStructs without providing ISigScanner");
            }
