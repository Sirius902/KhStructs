using KhStructs.Kh2.Object.GameObject;
...
public unsafe partial struct PartyList {
    [FixedSizeArray<Pointer<GameObject>>(3)]
    public fixed byte Members[3 * 8];
    public fixed int Flags18[3];

    public GameObject* Player => Instance()->MembersSpan[0];
    ...
    public static partial void ReplaceMember(int index, GameObject* gameObject);
}
