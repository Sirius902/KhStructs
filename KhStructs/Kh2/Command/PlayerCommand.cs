...
public unsafe partial struct PlayerCommand {
    ...
    [FixedSizeArray<CommandMenu>(19)] [FieldOffset(0x28)]
    public fixed byte CommandMenus[19 * 0x80];
    ...
    [FixedSizeArray<Pointer<CommandMenu>>(4)] [FieldOffset(0xAF0)]
    public fixed byte CommandMenuStack[4 * 8];

    [FieldOffset(0xB10)] public ReactionCommand ReactionCommand;
}
