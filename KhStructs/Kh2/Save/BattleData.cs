...
public unsafe partial struct BattleData {
    [FixedSizeArray<PartyData>(13)]
    [FieldOffset(0x00)] public fixed byte PartyData[13 * 0x114];
    [FixedSizeArray<FormData>(10)]
    [FieldOffset(0xE04)] public fixed byte FormData[10 * 0x38];
