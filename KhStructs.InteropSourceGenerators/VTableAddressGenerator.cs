...
internal sealed class VTableAddressGenerator : IIncrementalGenerator {
    private const string AttributeName = "KhStructs.Interop.Attributes.VTableAddressAttribute";
    ...
    internal sealed record StaticAddressInfo(StructInfo StructInfo, SignatureInfo SignatureInfo, int Offset,
        ...
        public static Validation<DiagnosticInfo, StaticAddressInfo> GetFromRoslyn(
            ...
            Option<AttributeData> staticAddressAttribute =
                namedTypeSymbol.GetFirstAttributeDataByTypeName(AttributeName);
            ...
            return (validStructInfo, validSignature, validOffset, validIsPointer).Apply(
                (structInfo, signature, offset, isPointer) =>
    ...
    private sealed record StructWithStaticAddressInfos
        ...
        public string RenderSource() {
            ...
            builder.AppendLine();
            builder.AppendLine(
                $"public static {StructInfo.Name}VTable StaticVTable => *({StructInfo.Name}VTable*)StaticAddressPointers.VTable;");
            builder.AppendLine();
