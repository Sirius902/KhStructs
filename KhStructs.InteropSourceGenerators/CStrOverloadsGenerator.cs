using KhStructs.InteropGenerator;
using KhStructs.InteropSourceGenerators.Extensions;
using KhStructs.InteropSourceGenerators.Models;
using LanguageExt;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;

namespace KhStructs.InteropSourceGenerators;

[Generator]
internal sealed class CStrOverloadsGenerator : IIncrementalGenerator {
    private const string AttributeName = "KhStructs.Interop.Attributes.GenerateCStrOverloadsAttribute";
